...
public interface BookingRepository extends JpaRepository<BookingEntity, String> {
    @Query("FROM BookingEntity b WHERE b.floorId = :floorId AND (b.startDate BETWEEN :rangeStart AND :rangeEnd OR b.endDate between :rangeEnd AND :rangeEnd OR (b.startDate <= :rangeStart AND b.endDate >= :rangeEnd))")
